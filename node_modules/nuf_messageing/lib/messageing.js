...
var Messageing = (function(){
    ...
    function Messageing(app, url){
        ...
        function onPostMessage(req, res){
            function ChunkReceiver(){
                ...
                function init(){
                    ...
                    _this.onData = onData;
                    _this.onHeaderLoaded = function(header){
                        //log("defaut ChunkReceiver.onHeaderLoaded with header:\n"+header);
                    };
                    Object.defineProperty(
                        _this,
                        "rawData",
        ...
        function appInit(app){
            ...
            log(
                "url:\n"+url+"\n"+
                "nuf_messageing adding app urls:\n"+
                "SSE client connection url:"+sseUrl+"\n"+
                "Post url:"+postUrl+"\n"+
                "messageingClient.js url:"+messageingClientUrl
            );
    ...
    Messageing.base64TobBlob = function(b64String, callback){
        ...
        .catch( function(exception){ throw exception;})
        ;
    };
